function(cpprest_find_botan)
  ...
  SET (BOTAN_LIBRARY Botan)
  add_library(${BOTAN_LIBRARY} INTERFACE)
  target_include_directories(${BOTAN_LIBRARY} INTERFACE ${BOTAN_INCLUDE_DIR})
  target_link_libraries(${BOTAN_LIBRARY} INTERFACE ${BOTAN_LIBRARIES})
